...
function Home() {
  ...
  const handleAdminLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("http://localhost:5000/api/voter/admin-login", {
        method: "POST",
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl font-black text-gray-800 mb-2">Voter Login</h2>
          <p className="text-gray-600 font-medium italic">Cast your vote using Face Verification</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-600 font-medium italic">Manage results and voter database</p>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-white w-full max-w-sm rounded-[2rem] p-8 relative shadow-2xl animate-in zoom-in duration-200">
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-2xl font-black text-gray-800">Admin Authorization</h3>
            </div>
