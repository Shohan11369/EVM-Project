...
import { User, IdCard, Camera, Loader2 } from "lucide-react";
...
function Signup() {
  ...
  const handleSignup = async () => {
    if (!name || !voterId) return alert("Please fill Name and Voter ID");
      ...
      <div className="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-2xl max-w-md w-full border border-white">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">
            Secure Biometric Voting Registration
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            <IdCard className="absolute left-3 top-3 text-gray-400 size-5" />
            <input
